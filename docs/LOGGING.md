...
```text
2025-05-12T14:30:00Z [INFO ] [cid=abc123] gerrit_to_platform.patchset_created: dispatching workflow gerrit-verify.yaml on owner/repo
```
...
```json
{"cid":"abc123","level":"INFO","logger":"gerrit_to_platform.patchset_created","message":"dispatch attempt platform=github owner=owner repo=repo workflow=verify ...","schema_version":"1","ts":"2025-05-12T14:30:00Z"}
```
